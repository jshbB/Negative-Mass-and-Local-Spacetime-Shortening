...
\begin{axis}[
    ...
    title={Positive Mass (Spacetime Dent)},
...
\begin{axis}[
    width=6cm, height=5cm,
    title={Negative Mass (Spacetime Hill)},
    xlabel={$x$}, ylabel={$y$}, zlabel={$z$},
    view={45}{30},
    colormap/viridis,
]
...
{(1/(x^2+y^2+0.1))}; % hill shape
\end{axis}

\end{tikzpicture}
\caption{Spacetime curvature for a point mass. Left: Positive mass curves spacetime inward (dent). Right: Negative mass curves spacetime outward (hill), visualizing ``spacetime shortening.''}
\end{figure}
