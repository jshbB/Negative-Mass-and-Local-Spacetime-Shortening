...
\begin{tikzpicture}
\begin{axis}[ ... ] % Positive mass plot
\addplot3[ surf, ... ]{-(1/(x^2+y^2+0.1))};
\end{axis}
\end{tikzpicture}
...
\section{Discussion}
While negative mass has not been observed experimentally, the mathematical framework is consistent with Einstein’s equations. This theory could provide a basis for further exploration in exotic spacetime geometries and tests of the limits of General Relativity. Future work includes considering extended mass distributions, dynamics of negative mass clusters, and coupling with quantum field effects.
